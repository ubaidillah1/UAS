    ...
    <div class="content-wrapper">
        <div class="col-12 grid-margin stretch-card">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama" id="nama" readonly value="{{$sup->nama}}">
                </div>
              </div>
              <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Alamat :</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="alamat" id="alamat" readonly value="{{$sup->alamat}}">
                </div>
                <label for="" class="col-sm-2 col-form-label">Kota :</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="kota" id="kota" readonly value="{{$sup->kota}}">
                </div>
              </div>
                <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">No Telpon :</label>
                <div class="col-sm-10">
                    <input type="email" class="form-control" name="telp" id="telp" readonly value="{{$sup->telp}}">
                </div>
                ...
                @endforeach
                <div class="col-sm-9">
                    <a  href="/supplier/index"  type="button" class="btn btn-outline-primary">Kembali</a>
                </div>
                </div>
                <hr>
